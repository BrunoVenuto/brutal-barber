    ...
    <footer className="bg-black text-white pt-20 border-t-8 border-yellow-500">
      <div id="unidade" className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-10 h-10 bg-zinc-900 flex items-center justify-center hover:bg-yellow-500 hover:text-black transition-all"
              >
                <Instagram size={20} />
              </a>
              <a
          ...
          <div>
            <h4 className="font-oswald text-xl font-bold mb-6 text-yellow-500">
              LOCALIZAÇÃO
            </h4>
          ...
          <div>
            ...
            <p className="text-zinc-500 text-xs mb-4">
              Receba dicas de estilo e promoções brutais.
            </p>
            <div className="flex">
              <input
                type="email"
              ...
              />
              <button className="bg-yellow-500 text-black px-4 hover:bg-yellow-400 transition-all font-bold">
                OK
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-zinc-900 py-10 flex flex-col md:flex-row justify-between items-center gap-6 text-zinc-600 text-xs tracking-widest uppercase">
          ...
          <div className="flex gap-8">
            ...
            <button
              onClick={scrollToTop}
              className="flex items-center gap-2 text-yellow-500 hover:text-white transition-all font-bold"
            >
